...
class StructDefDictEditor(tk.Toplevel):
    ...
    def _infosize_value_to_string(value: object) -> str:
        ...
        """
        return infosize_value_to_string(value, InfoSize)
    ...
    def _row_map_to_field_dict(self, row_map: dict[str, object]) -> dict:
        ...
        if isinstance(byte_swap, str):
            byte_swap = byte_swap.strip()
            if byte_swap.lower() in ("true", "false"):
                byte_swap = byte_swap.lower() == "true"
