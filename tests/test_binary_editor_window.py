...
def test_binary_editor_formatters_and_minimum_size(monkeypatch):
    ...
    assert module.BinaryEditorWindow._format_offset(offset) == "16,0"
    assert module.BinaryEditorWindow._format_offset(InfoSize(2, 3)) == "2,3"
    ...
    try:
        module.BinaryEditorWindow._minimum_struct_size(expression_struct_def)
